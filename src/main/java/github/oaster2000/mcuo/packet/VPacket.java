...
public class VPacket implements IMessage {
	...
	public VPacket(byte id) {

	}

	public VPacket(EntityPlayer player) {
	...
	public static class Handler implements IMessageHandler<VPacket, IMessage> {
		@Override
		public IMessage onMessage(VPacket message, MessageContext ctx) {
			...
			if (Missions.origins.isComplete() && ls.getLevel() > 25) {
					Abilities.strength(player);
			}
			return null;
		}
	}
