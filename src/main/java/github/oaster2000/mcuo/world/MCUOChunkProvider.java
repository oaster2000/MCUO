...
public class MCUOChunkProvider implements IChunkGenerator
{
    ...
    protected Biome biome = MCUOBiomes.FIELD;
    ...
    private int waterLakeChance =0;
    private int dungeonChance = 7;
    private int lavaLakeChance = 0;

    public MCUOChunkProvider(World worldIn)
    {
        // DEBUG
