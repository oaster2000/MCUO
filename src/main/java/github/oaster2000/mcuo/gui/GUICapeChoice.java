...
public class GUICapeChoice extends GuiChoiceBase {
	...
	public void initGui() {
		...
		this.torsoColorR.setText("" + (int)(mcuo.getCapeColorR() * 255));
		this.torsoColorG.setText("" + (int)(mcuo.getCapeColorG() * 255));
		this.torsoColorB.setText("" + (int)(mcuo.getCapeColorB() * 255));
		buttonList.clear();
	...
	protected void actionPerformed(GuiButton button) {
		switch (button.id) {
		case 0:
			MCUO.NETWORK.sendToServer(new CapeServerSyncMessage(mcuo.getCapeColorR(), mcuo.getCapeColorG(), mcuo.getCapeColorB(), mcuo.getCapeType(), mcuo.hasCreatedCharacter()));
			Minecraft.getMinecraft().displayGuiScreen(new GUITorsoChoice());
			return;
		case 1:
			MCUO.NETWORK.sendToServer(new CapeServerSyncMessage(mcuo.getCapeColorR(), mcuo.getCapeColorG(), mcuo.getCapeColorB(), mcuo.getCapeType(), mcuo.hasCreatedCharacter()));
			Minecraft.getMinecraft().displayGuiScreen(new GUIPowerChoice());
			return;
		case 2:
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		int j = this.guiTop;
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Cape", i + 230, j + 10, 0xffa7a7a7);
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Cape Color", i + 220, j + 50, 0xffa7a7a7);
